...
function fetchIncidentsData(map) {
    ...
    const incidents = [
        { id: 1, title: 'Порушення громадського порядку', lat: 50.4500, lng: 30.5200, type: 'порушення', severity: 'висока', status: 'активний' },
        { id: 2, title: 'Виявлення зброї', lat: 49.8400, lng: 24.0300, type: 'безпека', severity: 'середня', status: 'активний' },
        { id: 3, title: 'Порушення режиму охорони', lat: 48.4500, lng: 35.0500, type: 'порушення', severity: 'середня', status: 'активний' },
        { id: 4, title: 'Технічні проблеми на об'єкті', lat: 50.0000, lng: 36.2500, type: 'технічний', severity: 'низька', status: 'вирішений' },
        { id: 5, title: 'Затримання порушника', lat: 46.4800, lng: 30.7300, type: 'порушення', severity: 'висока', status: 'вирішений' }
    ];
