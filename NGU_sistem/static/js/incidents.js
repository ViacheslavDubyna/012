    ...
    const testData = [
        {
            ...
            description: 'Масове порушення громадського порядку під час проведення мітингу. Залучено підрозділи НГУ для стабілізації ситуації.',
            priority: 'high',
            status: 'active',
            location: {
                lat: 50.4501,
        ...
        {
            id: 'INC-2025-0141',
            title: 'Охорона масового заходу',
            description: 'Забезпечення охорони громадського порядку під час проведення масового культурного заходу. Задіяно 3 взводи НГУ.',
            priority: 'medium',
            status: 'in-progress',
            location: {
                lat: 49.8397,
        ...
        {
            id: 'INC-2025-0140',
            title: 'Охорона критичної інфраструктури',
            description: 'Посилення охорони об\'єкту критичної інфраструктури у зв\'язку з підвищеним рівнем загрози. Розгорнуто додатковий пост НГУ.',
            priority: 'high',
            status: 'in-progress',
            location: {
                lat: 49.9935,
        ...
        {
            id: 'INC-2025-0139',
            title: 'Конвоювання особливо небезпечних злочинців',
            description: 'Забезпечення безпеки під час конвоювання особливо небезпечних злочинців до суду. Задіяно спеціальний підрозділ НГУ.',
            priority: 'medium',
            status: 'resolved',
            location: {
                lat: 46.4825,
        ...
        {
            id: 'INC-2025-0138',
            title: 'Антитерористичні навчання',
            description: 'Проведення планових антитерористичних навчань спільно з іншими силовими структурами. Задіяно підрозділи спеціального призначення НГУ.',
            priority: 'low',
            status: 'resolved',
            location: {
                lat: 48.4647,
