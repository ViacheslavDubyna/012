...
"""
Модуль для навчання моделей машинного навчання для інформаційно-аналітичної системи ДПСУ
...
def train_incident_predictor(test_size=0.2, random_state=42):
    """
    Навчання моделі прогнозування інцидентів на кордоні
...
def train_border_crossing_predictor(test_size=0.2, random_state=42):
    """
    Навчання моделі прогнозування кількості перетинів кордону
...
def train_all_models():
    ...
    print("\nВсі моделі успішно навчені та збережені.")
