...
"""
Модуль предикторів для інформаційно-аналітичної системи ДПСУ
...
class IncidentPredictor:
    """Клас для прогнозування інцидентів на кордоні"""
...
class BorderCrossingPredictor:
    """Клас для прогнозування кількості перетинів кордону"""
